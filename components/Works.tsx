    ...
    <section className='py-12' id='works'>
      <div className='container mx-auto px-4'>
        ...
        <div className='gallery grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
          <img src='../image/photo.webp' alt='Example Work 1' className='rounded shadow-md' />
          <img src='../image/salena.webp' alt='Example Work 2' className='rounded shadow-md' />
          <img src='../image/zara.jpg' alt='Example Work 2' className='rounded shadow-md' />
        </div>
